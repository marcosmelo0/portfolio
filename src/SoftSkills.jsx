        ...
        <div className="bg-base-300 md:p-10 p-0 rounded-sm">
          <div>
            <ul className="flex flex-col my-3 bg-base-100 rounded-sm">
              <li className="hover:bg-primary text-lg font-thin transition-all duration-300 p-4 hover:p-8 hover:text-primary-content hover:font-normal border-b-4 border-base-300">
              ...
              <li className="hover:bg-primary text-lg font-thin transition-all duration-300 p-2 hover:p-4 hover:text-primary-content hover:font-normal border-b-4 border-base-300">
